...
- [Raspberry Pi OS (Legacy) 32-bit 2023-02-22](https://downloads.raspberrypi.com/raspios_oldstable_armhf/images/raspios_oldstable_armhf-2023-02-22/) [[kernel 5.10.110]](https://github.com/raspberrypi/linux/tree/rpi-5.10.y)
...
$ git clone -b rpi-5.15.y git@github.com:raspberrypi/linux.git

# technexion rpi camera driver
$ git clone git@github.com:TechNexion-Vision/tn-rpi-camera-driver.git
```
...
$ sudo cp -ra modules/lib/modules/5.10.110-v7l-tn-raspi/ /media/$user/rootfs/lib/modules/.
$ sync
```
...
2. Bring up the camera (/dev/video0) with 640x480 by Gstreamer pipeline:
...
3. Change resolution with 1280x720 and bring up by Gstreamer pipeline
