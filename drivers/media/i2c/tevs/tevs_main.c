		       ...
		       struct v4l2_subdev_format *format)
{
	...
	if (format->which == V4L2_SUBDEV_FORMAT_TRY)
		fmt = v4l2_subdev_get_try_format(sub_dev, cfg, format->pad);
	else
		fmt = &tevs->fmt;
...
static int tevs_open(struct v4l2_subdev *sub_dev, struct v4l2_subdev_fh *fh)
{
	...
	struct v4l2_mbus_framefmt *try_fmt_img =
		v4l2_subdev_get_try_format(sub_dev, fh->pad, 0);
	struct v4l2_rect *try_crop = 
        v4l2_subdev_get_try_crop(sub_dev, fh->pad, 0);
...
static int tevs_probe(struct i2c_client *client)
{
	...
	ret = v4l2_async_register_subdev_sensor_common(&tevs->v4l2_subdev);
	if (ret != 0) {
